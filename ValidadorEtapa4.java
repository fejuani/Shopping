public class ValidadorEtapa4 {
	...
	public static void main(String[] args){
		...
		System.out.println(loja1.getQuantidadeFuncionario() == 5 ? "[OK] Método Loja.getQuantidadeFuncionario()" : "[NOK] Método Loja.getQuantidadeFuncionario()");

		//public void setQuantidadeFuncionario(int quantidadeFuncionarios);
		loja1.setQuantidadeFuncionario(3);
		System.out.println("[OK] Método Loja.setQuantidadeFuncionario()");

		//public double getSalarioFuncionario();
		System.out.println(loja1.getSalarioFuncionario() == -1 ? "[OK] Método Loja.getSalarioFuncionario()" : "[NOK] Método Loja.getSalarioFuncionario()");

		//public void setSalarioFuncionario(double salarioBaseFuncionario);
		loja1.setSalarioFuncionario(3000);
		System.out.println("[OK] Método Loja.setSalarioFuncionario()");
		...
		System.out.println(loja1.tamanhoLoja() == 'P' ? "[OK] Método Loja.tamanhoDaLoja()" : "[NOK] Método Loja.tamanhoDaLoja()");
		...
		boolean prod1 = loja2.insereProdutos(new Produto("Pipoca doce", 5, new Data(10,5,2023)));
		...
		boolean prod2 = loja2.insereProdutos(new Produto("Pipoca salgada", 4, new Data(15,5,2023)));
		...
		boolean prod3 = loja2.insereProdutos(new Produto("Pipoca caramelo", 5, new Data(12,5,2023)));
		...
		//Criação da instância
		Vestuario lojaVestuario = new Vestuario("Loja Vestuário", 10, 2100, e1, d1, 10, false);
		...
		//Criação da instância
		Alimentacao lojaAlimentacao = new Alimentacao("Loja Alimentação", 10, 2100, e1, d1, 10, d1);
		...
		System.out.println(maisCaro.getSeguroEletronico() == 800 ? "[OK] Método Shopping.lojaSeguroMaisCaro()" : "[NOK] Método Shopping.lojaSeguroMaisCaro");
